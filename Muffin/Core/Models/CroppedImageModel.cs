...
namespace Muffin.Core.Models
{
    ...
    /// </summary>
    public class CroppedImageModel : DynamicObject, ICropImageModel, INullModel
    {
        ...
        public static CroppedImageModel Create(string json) //allow to have a parameterless constructor, to take advantage of the JsonConvert('ers)
        {
            var ret = JsonConvert.DeserializeObject<CroppedImageModel>(json);
            return ret;
        }
